  // В файле src/components/NavBar/NavBar.jsx

  import React from 'react';
  import { Link, useNavigate } from 'react-router-dom';
  import { useSelector, useDispatch } from 'react-redux';
  import { logout } from '../../features/user/userSlice';
  import logo from '../../styles/images/logo.svg'; // Укажите правильный путь до вашего логотипа
  import playIcon from '../../styles/images/icons/play.svg'; // Путь до иконки
  import tvIcon from '../../styles/images/icons/TV.svg'; // Путь до иконки

  const NavBar = () => {
    const user = useSelector(state => state.user.currentUser || {}); // Использование {} как значения по умолчанию
